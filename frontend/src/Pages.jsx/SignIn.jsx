        ...
        <div className="w-full max-w-md px-4">
          ...
          <div className="mb-8 text-center">
            <div className="flex items-center justify-center mb-4">
              ...
              <h1 className="text-4xl font-bold text-gray-900">Welcome<span className="text-indigo-600">Back</span></h1>
            </div>
            <p className="text-gray-600 mt-2">Sign in to continue your local journey</p>
          </div>
          ...
          <form onSubmit={handleSignIn} className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-8 text-center">Account Login</h2>
          ...
          <p className="text-center mt-6 text-gray-600 text-sm">
            New Here?{' '}
            <a href="/signup" className="text-indigo-600 hover:text-indigo-400 font-medium">
              Create an account
            </a>
          </p>
        </div>
